...
/// <summary>一个地点在用户表达中使用的其他名称。</summary>
[SugarTable("place_aliases")]
[SugarIndex("ux_place_aliases_user_place_name", nameof(UserId), OrderByType.Asc, nameof(PlaceId), OrderByType.Asc, nameof(NormalizedName), OrderByType.Asc, true)]
[SugarIndex("ix_place_aliases_user_name", nameof(UserId), OrderByType.Asc, nameof(NormalizedName), OrderByType.Asc)]
